...
public class Art {
	...
	public static void main(String[] args) throws IOException {
		...
		int dots = 3000;
		int numImages = 20;
		String folderPath = "c:\\Users\\Davis\\computerArt\\mom\\";
		File f = new File(folderPath);
		f.mkdirs();
		// Create a bunch of images
		for (int i = 0; i < numImages; i++) {
			Art a = new Art(width, height, dots, getColorScheme(), true, true);
			...
			ImageIO.write(bi, "PNG", new File(folderPath + "test" + i + ".png"));
		}
	...
	public static Color[] getColorScheme() {
		...
		//Color c1 = randColor(); 
		//Color c2 = randColor();
		Color c1 = new Color(156, 100, 217);
		Color c2 = new Color(207, 186, 230);
	...
	public static final float TOO_SMALL_RADII = 10.0f;
	public static final float CONTAINS_TOLERANCE = 5.0f;
	...
	public Art(float width, float height, int num, Color[] colorScheme, boolean tooSmall, boolean withinBounds) {
